...
import type { Prisma, Category } from "../../../../../restaurant-manager/generated/prisma";
...
export function useCheckCategory<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; restaurantId?: string; name?: string; description?: string; sortOrder?: number; isActive?: boolean; parentId?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
