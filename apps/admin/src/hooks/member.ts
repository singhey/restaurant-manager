...
import type { Prisma, Member } from "../../../../../restaurant-manager/generated/prisma";
...
export function useCheckMember<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; organizationId?: string; userId?: number; email?: string; role?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
