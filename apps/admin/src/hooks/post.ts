...
import type { Prisma, Post } from "../../../../../restaurant-manager/generated/prisma";
...
export function useCheckPost<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: number; title?: string; content?: string; published?: boolean; viewCount?: number; authorId?: number }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
