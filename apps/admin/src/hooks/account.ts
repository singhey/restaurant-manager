...
import type { Prisma, Account } from "../../../../../restaurant-manager/generated/prisma";
...
export function useCheckAccount<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; accountId?: string; providerId?: string; userId?: number; accessToken?: string; refreshToken?: string; idToken?: string; scope?: string; password?: string }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
