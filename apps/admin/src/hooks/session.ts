...
import type { Prisma, Session } from "../../../../../restaurant-manager/generated/prisma";
...
export function useCheckSession<TError = DefaultError>(args: { operation: PolicyCrudKind; where?: { id?: string; token?: string; ipAddress?: string; userAgent?: string; userId?: number }; }, options?: (Omit<UseQueryOptions<boolean, TError, boolean>, 'queryKey'> & ExtraQueryOptions)) {
    const { endpoint, fetch } = getHooksContext();
